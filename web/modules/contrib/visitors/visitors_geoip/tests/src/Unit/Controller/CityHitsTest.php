 ...
 */
class CityHitsTest extends UnitTestCase {
  ...
  /**
   * The CityHits controller.
   *
   * @var \Drupal\visitors_geoip\Controller\CityHits
   */
  ...
  public function testDisplay() {
    ...
    $output = $this->controller->display($country, $city);
